...
namespace LibraryProject.Migrations
{
    ...
    [Migration("20201105090005_PopulateAuthors")]
    partial class PopulateAuthors
    {
            ...
            modelBuilder.Entity("LibraryProject.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, DebutYear = 1990, FirstName = "Nicholas", LastName = "Sparks", Ranking = 10 },
                        new { Id = 2, DebutYear = 1890, FirstName = "J.R.R", LastName = "Tolkien", Ranking = 4 },
                        new { Id = 3, DebutYear = 2000, FirstName = "Delia", LastName = "Owens", Ranking = 7 },
                        new { Id = 4, DebutYear = 2007, FirstName = "Ryan", LastName = "Holiday", Ranking = 32 },
                        new { Id = 5, DebutYear = 1970, FirstName = "Charles", LastName = "Duhigg", Ranking = 15 },
                        new { Id = 6, DebutYear = 2006, FirstName = "Andy", LastName = "Weir", Ranking = 2 },
                        new { Id = 7, DebutYear = 2006, FirstName = "Martha", LastName = "Stewart", Ranking = 2 },
                        new { Id = 8, DebutYear = 2006, FirstName = "John", LastName = "Doe", Ranking = 2 }
                    );
                });
